...
//        AppUtility.lockOrientation(UIInterfaceOrientationMask.portrait, andRotateTo: UIInterfaceOrientation.portrait)
        ...
        for i in 0..<40 {
            ...
            if(i<8){
                imageView.frame = CGRect(x:n*i+5,y:n+offset,width:n-5,height:n-5)
            }else if(i<16){
                imageView.frame = CGRect(x:n*(i-8)+5,y:n*2+offset,width:n-5,height:n-5)
            }else if(i<24){
                imageView.frame = CGRect(x:n*(i-16)+5,y:n*3+offset,width:n-5,height:n-5)
            }else if(i<32){
                imageView.frame = CGRect(x:n*(i-24)+5,y:n*4+offset,width:n-5,height:n-5)
            }else{
                imageView.frame = CGRect(x:n*(i-32)+5,y:n*5+offset,width:n-5,height:n-5)
            }
        ...
        for view in self.view.subviews as [UIView] {
            ...
            view.layer.minificationFilter = CALayerContentsFilter.nearest
        }
        super.viewDidLoad()
    }
